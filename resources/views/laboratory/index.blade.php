...
@section('content')
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
        ...
        <div
            ...
            <a href="{{ route('laboratory.patient_registration') }}"
        ...
        <div
            ...
            <a href="{{ route('laboratory.manage_test') }}"
        ...
        <div
            ...
            <a href="{{ route('laboratory.add_test_particulars') }}"
        ...
        <div
            ...
            <a href="{{ route('laboratory.test_catalog') }}"
        ...
        <div
            ...
            <a href="{{ route('laboratory.result_entry.search') }}"
                class="bg-gray-600 hover:bg-gray-600 text-white font-medium py-2 px-5 rounded-full shadow-md transition-colors duration-200 ease-in-out">Enter
                Results</a>
        </div>
