                ...
                <form method="GET" action="{{ route('pathology.lab_financial_summary') }}">
                    ...
                    <div class="hms-lsr-filter-grid">
                        ...
                        @else
                            ...
                            <x-form.field label="Collection Center" for="lfs_collection_center_id">
                                <select id="lfs_collection_center_id" name="collection_center_id" class="hms-select hms-lsr-input-focus">
