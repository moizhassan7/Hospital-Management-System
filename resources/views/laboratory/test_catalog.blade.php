...
@section('content')
    <div class="flex items-center justify-between mb-8">
        <div>
            <h2 class="text-4xl font-extrabold text-gray-900 tracking-tight">Test Catalog</h2>
            <p class="text-gray-500 mt-2 text-lg">Detailed overview of all available laboratory tests and their parameters.</p>
        </div>
        <a href="{{ route('laboratory.index') }}" class="bg-white border border-gray-300 hover:bg-gray-50 text-gray-700 font-semibold py-2.5 px-6 rounded-xl shadow-sm transition-all duration-200 ease-in-out flex items-center group">
