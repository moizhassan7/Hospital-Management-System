...
@section('content')
    <div class="hms-page-toolbar"><div><h2 class="hms-page-heading">Day Care Procedures</h2></div>
        <div class="flex space-x-4">
            ...
            <a href="{{ route('dashboard') }}" class="hms-back-btn">
...
<div class="mb-4">
        <form action="{{ route('daycare.index') }}" method="GET">
            <div class="flex items-center space-x-2">
                <input type="text" name="query" placeholder="Search by name, MR No., or ID" value="{{ request('query') }}" class="hms-input">
