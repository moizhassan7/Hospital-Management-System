@php
    ...
    $name = $name ?? config('hospital.name');
    $shortName = $shortName ?? config('hospital.short_name');
    $city = $city ?? config('hospital.city');
    $address = $address ?? config('hospital.address');
    $phone = $phone ?? config('hospital.phone');
    $email = $email ?? config('hospital.email');
