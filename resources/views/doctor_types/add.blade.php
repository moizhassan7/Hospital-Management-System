...
@section('content')
    <div class="flex items-center justify-between mb-6">
        <h2 class="text-3xl font-bold text-gray-800">Add New Doctor Type</h2>
        ...
        <form action="#" method="POST"> {{-- Action will be updated later for actual submission --}}
            ...
            <div class="grid grid-cols-1 gap-6 mb-6">
                <div>
                    ...
                    <input type="text" id="doctor_type_name" name="doctor_type_name" class="shadow appearance-none border rounded-lg w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent" placeholder="e.g., Consultant, Resident" required>
                </div>
            </div>
        ...
        <div class="overflow-x-auto">
            <table class="min-w-full bg-white rounded-lg overflow-hidden">
                ...
                <tbody class="divide-y divide-gray-200">
                    {{-- Static Doctor Type Data --}}
                    @php
                        $doctorTypes = [
                            ['id' => 'DT001', 'name' => 'Consultant'],
                            ['id' => 'DT002', 'name' => 'Resident'],
                            ['id' => 'DT003', 'name' => 'Intern'],
                            ['id' => 'DT004', 'name' => 'Fellow'],
                            ['id' => 'DT005', 'name' => 'Visiting Doctor'],
                        ];
                    @endphp
                    @foreach($doctorTypes as $index => $type)
                        <tr>
