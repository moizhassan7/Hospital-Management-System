...
@section('content')
    <div class="hms-page-toolbar"><div><h2 class="hms-page-heading">Emergency Patient Registration</h2></div>
        ...
        <a href="{{ route('emergency.index') }}" class="hms-back-btn">
    ...
    <div class="hms-panel hms-panel-padded mb-5">
        ...
        <form id="emergency_patient_form" action="{{ route('emergency.patients.store') }}" method="POST">
            ...
            <div class="hms-form-grid mb-6">
                ...
                <div>
                    <label for="emergency_hours" class="hms-label">Emergency Hours:</label>
                    <input type="number" id="emergency_hours" name="emergency_hours" class="hms-input" placeholder="e.g., 2" min="1" value="1" required>
                </div>
                <div>
            ...
            <h3 class="hms-section-title mt-8">Consultant Fees</h3>
            <div class="mb-6">
            ...
            <div class="mt-8">
                <h3 class="hms-section-title">Billing & Payments</h3>
                <div class="hms-form-grid mb-6">
                    <div>
                        <label for="first_hour_charges" class="hms-label">First Hour Charges (PKR):</label>
                        <input type="number" id="first_hour_charges" name="first_hour_charges" class="hms-input hms-input-readonly" value="{{ $emergencyCharges->first_hour_charges ?? 0 }}" readonly>
                    </div>
                    <div>
                        <label for="other_hours_charges" class="hms-label">Other Hours Charges (PKR):</label>
                        <input type="number" id="other_hours_charges" name="other_hours_charges" class="hms-input hms-input-readonly" value="{{ $emergencyCharges->other_hours_charges ?? 0 }}" readonly>
                    </div>
                    <div>
                        <label for="total_fee" class="hms-label">Total Fee (PKR):</label>
                    ...
                    <div>
                        <label for="amount_paid" class="hms-label">Amount Paid (PKR):</label>
                        <input type="number" id="amount_paid" name="amount_paid" class="hms-input focus:ring-2 focus:ring-blue-500" min="0" required>
                    </div>
                    <div>
                        <label for="amount_receivable" class="hms-label">Amount Receivable (PKR):</label>
                        <input type="text" id="amount_receivable" name="amount_receivable" class="hms-input hms-input-readonly" readonly>
                    </div>
                </div>
            </div>
