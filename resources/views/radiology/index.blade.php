...
@section('content')
    <div class="flex items-center justify-between mb-6">
        <h2 class="text-3xl font-bold text-gray-800">Radiology Management</h2>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
        ...
        <div
            ...
            <p class="text-gray-600 text-center mb-4 text-sm">Register patients for radiology scans (X-Ray, MRI, etc.).</p>
            <a href="{{ route('radiology.patient_registration') }}"
        ...
        <div
            ...
            <h3 class="text-xl font-semibold text-gray-800 mb-2">Reporting & Results</h3>
            <p class="text-gray-600 text-center mb-4 text-sm">Enter findings, impressions and upload scan images.</p>
            <a href="{{ route('radiology.result_entry.search') }}"
        ...
        <div
            ...
            <h3 class="text-xl font-semibold text-gray-800 mb-2">Radiology Catalog</h3>
            <p class="text-gray-600 text-center mb-4 text-sm">View all radiology procedures and templates.</p>
            <a href="{{ route('radiology.test_catalog') }}"
        ...
        <div
            ...
            <h3 class="text-xl font-semibold text-gray-800 mb-2">Manage Modalities</h3>
            <p class="text-gray-600 text-center mb-4 text-sm">Define and organize radiology modalities.</p>
            <a href="{{ route('radiology.test_head') }}"
        ...
        <div
            ...
            <h3 class="text-xl font-semibold text-gray-800 mb-2">Manage Scans</h3>
            <p class="text-gray-600 text-center mb-4 text-sm">Add, edit, or remove radiology scans.</p>
            <a href="{{ route('radiology.manage_test') }}"
