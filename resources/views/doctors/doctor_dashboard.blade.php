...
@section('content')
    <div class="hms-page-toolbar"><div><h2 class="hms-page-heading">Doctor's Dashboard</h2></div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6 mb-8">
        ...
        <div class="hms-panel flex flex-col items-center justify-center transition-transform transform hover:scale-105 hover:shadow-2xl duration-300">
